...
const DOWNLOAD_ASSETS: DownloadAsset[] = [
  { os: 'windows', label: 'Windows 10/11 (Instalador)',  url: '/downloads/Nimbus-Launcher-Setup-0.1.0.exe', format: 'installer', size: '~72 MB' },
  { os: 'windows', label: 'Windows (Portable EXE)',      url: '/downloads/Nimbus-Launcher-Portable-0.1.0.exe', format: 'portable',  size: '~71 MB' },
  { os: 'windows', label: 'Windows (Portable ZIP)',      url: '/downloads/Nimbus-Launcher-v0.1.0-win-x64.zip', format: 'portable',  size: '~110 MB' },
  ...
  return (
    <div style={{ padding: '64px 24px 80px', maxWidth: 980, margin: '0 auto', animation: 'fadeIn 250ms ease' }}>
      ...
      <div style={{ textAlign: 'center', marginTop: '36px', fontSize: '12px', color: M.textMuted }}>
        Versão atual: 0.1.0 — <a href="https://github.com/nimbus-launcher" style={{ color: M.accent, textDecoration: 'none' }}>Código fonte</a>
      </div>
    </div>
  )
}
